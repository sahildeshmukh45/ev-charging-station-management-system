...
INSERT INTO `bookevstation` (`id`,`name`,`vehicalname`,`vehicalno`,`city`,`area`,`time`,`date`,`accountname`,`accountno`,`ifsc`,`amount`,`status`) VALUES 
...
INSERT INTO `owner` (`id`,`name`,`address`,`email`,`mobileno`,`dob`,`password`,`status`) VALUES 
